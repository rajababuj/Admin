...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets\css\poppins\poppins-v5-latin-700.woff2') }}">
    <link rel="stylesheet" href="{{ asset('assets\css\poppins\poppins-v5-latin-700.woff') }}">
    <link rel="stylesheet" href="{{ asset('assets\css\poppins\poppins-v5-latin-700.woff') }}">
    <link rel="stylesheet" href="{{ asset('assets\css\poppins\poppins-v5-latin-700.ttf') }}">
...
<body>
    ...
    <script src="{{asset ('assets/css/fonts/Material-Design-Iconic-Fontd1f1.ttf') }}"></script>
